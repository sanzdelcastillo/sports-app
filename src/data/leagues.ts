...
export const LEAGUES: Record<KnownLeagueId, League> = {
  ...
  ucl: {
    ...
    shortName: 'Champions League', code: 'UCL',
    accent: '#1B2A6B',
    providerId: '2',
    currentSeason: 2026,
  },
  ...
  eflcup: { id: 'eflcup', name: 'EFL Cup', shortName: 'League Cup', code: 'EFL', accent: '#0A3D62', providerId: '48', currentSeason: 2026 },
  facup: { id: 'facup', name: 'FA Cup', shortName: 'FA Cup', accent: '#B4172D', providerId: '45', currentSeason: 2026 },
  communityshield: { id: 'communityshield', name: 'Community Shield', shortName: 'Community Shield', accent: '#B4172D', providerId: '528', currentSeason: 2026 },
  uel: { id: 'uel', name: 'UEFA Europa League', shortName: 'Europa League', code: 'UEL', accent: '#F58220', providerId: '3', currentSeason: 2026 },
  uecl: { id: 'uecl', name: 'UEFA Conference League', shortName: 'Conference League', code: 'UECL', accent: '#2F7D32', providerId: '848', currentSeason: 2026 },
  uefasupercup: { id: 'uefasupercup', name: 'UEFA Super Cup', shortName: 'UEFA Super Cup', code: 'USC', accent: '#1B2A6B', providerId: '531', currentSeason: 2026 },
  copadelrey: { id: 'copadelrey', name: 'Copa del Rey', shortName: 'Copa del Rey', accent: '#C8102E', providerId: '143', currentSeason: 2026 },
  supercopa: { id: 'supercopa', name: 'Supercopa de España', shortName: 'Supercopa de España', code: 'SCE', accent: '#C8102E', providerId: '556', currentSeason: 2026 },
  coppaitalia: { id: 'coppaitalia', name: 'Coppa Italia', shortName: 'Coppa Italia', accent: '#024494', providerId: '137', currentSeason: 2026 },
  supercoppa: { id: 'supercoppa', name: 'Supercoppa Italiana', shortName: 'Supercoppa Italiana', code: 'SCI', accent: '#024494', providerId: '547', currentSeason: 2025 },
  ...
  usopencup: { id: 'usopencup', name: 'U.S. Open Cup', shortName: 'U.S. Open Cup', code: 'USOC', accent: '#0B3D91', providerId: '257', currentSeason: 2026 },
  ...
  spfl: { id: 'spfl', name: 'Scottish Premiership', shortName: 'Scottish Premiership', code: 'SPFL', accent: '#1B3F8B', providerId: '179', currentSeason: 2026 },
  superlig: { id: 'superlig', name: 'Turkish Süper Lig', shortName: 'Süper Lig', accent: '#C8102E', providerId: '203', currentSeason: 2026 },
  argprimera: { id: 'argprimera', name: 'Argentine Primera División', shortName: 'Liga Argentina', code: 'ARG', accent: '#6CACE4', providerId: '128', currentSeason: 2026 },
  saudipro: { id: 'saudipro', name: 'Saudi Pro League', shortName: 'Saudi Pro League', code: 'SPL', accent: '#1C7A3C', providerId: '307', currentSeason: 2026 },
  ...
  euros: { id: 'euros', name: 'UEFA European Championship', shortName: 'European Championship', code: 'EURO', accent: '#0E4C92', providerId: '4', currentSeason: 2024 },
  ...
  uefanations: { id: 'uefanations', name: 'UEFA Nations League', shortName: 'UEFA Nations League', code: 'UNL', accent: '#0E4C92', providerId: '5', currentSeason: 2026 },
  concacafnations: { id: 'concacafnations', name: 'CONCACAF Nations League', shortName: 'CONCACAF Nations League', code: 'CNL', accent: '#0B3D91', providerId: '536', currentSeason: 2024 },
  ...
  libertadores: { id: 'libertadores', name: 'Copa Libertadores', shortName: 'Copa Libertadores', code: 'LIB', accent: '#A6192E', providerId: '13', currentSeason: 2026 },
  concacafcc: { id: 'concacafcc', name: 'CONCACAF Champions Cup', shortName: 'CONCACAF Champions Cup', code: 'CCC', accent: '#0B3D91', providerId: '16', currentSeason: 2026 },
  wcqconcacaf: { id: 'wcqconcacaf', name: 'World Cup Qualifying · CONCACAF', shortName: 'World Cup Qualifying · CONCACAF', code: 'WCQ', accent: '#0B3D91', providerId: '31', currentSeason: 2026 },
  wcqconmebol: { id: 'wcqconmebol', name: 'World Cup Qualifying · CONMEBOL', shortName: 'World Cup Qualifying · CONMEBOL', code: 'WCQ', accent: '#A6192E', providerId: '34', currentSeason: 2026 },
  wcquefa: { id: 'wcquefa', name: 'World Cup Qualifying · UEFA', shortName: 'World Cup Qualifying · UEFA', code: 'WCQ', accent: '#0E4C92', providerId: '32', currentSeason: 2024 },
  other: {
    id: 'other',
    name: 'Soccer',
    shortName: 'Soccer',
