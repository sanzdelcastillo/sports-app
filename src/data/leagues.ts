...
export const LEAGUES: Record<KnownLeagueId, League> = {
  ...
  concacafnations: { id: 'concacafnations', name: 'CONCACAF Nations League', shortName: 'CONCACAF Nations', code: 'CNL', accent: '#0B3D91', providerId: '536', currentSeason: 2024 },
  ...
  concacafcc: { id: 'concacafcc', name: 'CONCACAF Champions Cup', shortName: 'CONCACAF Champions', code: 'CCC', accent: '#0B3D91', providerId: '16', currentSeason: 2026 },
  wcqconcacaf: { id: 'wcqconcacaf', name: 'World Cup Qualifying · CONCACAF', shortName: 'WC Qualifying · CONCACAF', code: 'WCQ', accent: '#0B3D91', providerId: '31', currentSeason: 2026 },
  wcqconmebol: { id: 'wcqconmebol', name: 'World Cup Qualifying · CONMEBOL', shortName: 'WC Qualifying · CONMEBOL', code: 'WCQ', accent: '#A6192E', providerId: '34', currentSeason: 2026 },
  wcquefa: { id: 'wcquefa', name: 'World Cup Qualifying · UEFA', shortName: 'WC Qualifying · UEFA', code: 'WCQ', accent: '#0E4C92', providerId: '32', currentSeason: 2024 },
  other: {
    id: 'other',
    name: 'Soccer',
    shortName: 'Soccer',
